...
export function instrument(
  ...
  try {
    ...
    exporter = getMetisExporter(apiKey, exporterUrl, options, options.printToConsole);

    tracerProvider.addSpanProcessor(new BatchSpanProcessor(exporter, DEFAULT_BATCH_PROCESSOR_CONFIG));
